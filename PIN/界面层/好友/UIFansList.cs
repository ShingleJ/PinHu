...
namespace PIN
{
    public partial class UIFansList : Form
    {
        public UIFansList()
        {
            InitializeComponent();
        ...
        private void UIFansList_Load(object sender, EventArgs e)
        {
            LoadFansList();
        }
        ...
        private void LoadFansList()
        {
            ...
            String commandTextQuery = "select FollowUser_FollowerName from FollowUser where FollowUser_UserName = '" + Parameters.username + "'";
        ...
        private void ShowFansList(List<String[]> read)
        {
