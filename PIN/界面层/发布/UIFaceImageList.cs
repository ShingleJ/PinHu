...
namespace PIN
{ 
    public class UIFaceImageList : System.Windows.Forms.Form
        {
            ...
            #region Events
            public event FaceImagelistEventHandler ItemClick = null;
            #endregion

            #region Constructor
            public UIFaceImageList()
            {
                // Window Style
            ...
            {
                // We repaint IT if the mouse is no more over it
                ...
                else
                {
                    switch (kea.KeyCode)
                    {
                        ...
                        case Keys.Space:
                            ...
                            {
                                ItemClick(this, new FaceImageListEventArgs(nImageId));
                                _nCoordX = -1;
                                _nCoordY = -1;
                                Hide();
                            }
	...
	public class FaceImageListEventArgs : EventArgs
	{
       
        public int SelectedItem;

        public FaceImageListEventArgs(int selectedItem)
        {
            SelectedItem = selectedItem;
        }
	}

    public delegate void FaceImagelistEventHandler(object sender, FaceImageListEventArgs ilpea);
